    ...
    <section className="flex flex-col items-center justify-center min-h-[70vh] px-4 mt-15 mb-20 relative">
      ...
      <div className="mural-board max-w-4xl w-full relative flex justify-center items-center py-16 px-4 overflow-hidden md:overflow-visible shadow-2xl">
        ...
        <div className="absolute top-8 left-4 md:left-12 w-20 h-28 bg-[#fdf8f5] rotate-[-15deg] shadow-md border border-[#2c1a12]/10 rounded-sm z-0 flex flex-col items-center pt-4 px-2">
          <div className="absolute -top-2 w-8 h-3 bg-[#d29c73]/60 rotate-10"></div>
        ...
        {/* 2. Esquerda Meio */}
        <div className="absolute top-1/2 -translate-y-1/2 -left-2 md:left-4 w-16 h-20 bg-[#e6d3c3] rotate-12 shadow-md border border-[#2c1a12]/10 rounded-sm z-0 flex flex-col items-center pt-3 px-2">
        ...
        {/* 4. Direita Superior */}
        <div className="absolute top-6 right-6 md:right-16 w-16 h-24 bg-[rgba(246,228,211,0.9)] rotate-20 shadow-sm border border-[#2c1a12]/5 rounded-sm z-0 flex flex-col items-center pt-3 px-2">
        ...
        {/* 6. Direita Inferior */}
        <div className="absolute bottom-10 right-4 md:right-14 w-20 h-32 bg-[#e6d3c3] rotate-15 shadow-md border border-[#2c1a12]/10 rounded-sm z-0 flex flex-col items-center pt-4 px-2">
          <div className="w-[90%] h-1 bg-[#4a3732]/10 rounded-full mb-2"></div>
          <div className="w-full h-1 bg-[#4a3732]/10 rounded-full mb-2"></div>
        ...
        <div className="comanda-wrapper relative z-10 w-full max-w-lg">
          ...
          <div className="w-full comanda-card pt-12 pb-12 px-6 md:px-12 comanda-lines flex flex-col items-center text-center border border-[#2c1a12]/10">
            {/* ADESIVO COM O EMOJI */}
            <div className="w-28 h-28 mb-8 bg-[#fdf8f5] rounded-full shadow-[2px_4px_12px_rgba(44,26,18,0.15)] flex items-center justify-center border-2 border-[#dab39e]/50 relative -rotate-6 z-10">
              ...
              <div className="absolute top-3 left-4 w-6 h-2 bg-white/60 rounded-full -rotate-45"></div>

              {/* NOVA ETIQUETA #404 */}
              {/* Parece um código de produto/preço pendurado no adesivo */}
              <div className="absolute -bottom-2 -right-4 bg-[#4a3732] text-[#f6e4d3] px-3 py-1 rounded-md text-sm font-black tracking-widest rotate-15 shadow-[2px_2px_0px_#2c1a12] border-2 border-[#fdf8f5] geist-mono z-20">
                404
              </div>
            </div>

            <h3 className="text-3xl font-bold text-[#2c1a12] mb-0 leading-10">
              Página não encontrada
            </h3>

            <p className="geist text-[#4a3732] text-lg font-medium leading-10 mb-8">
